...
class T_FlexCalibration(object):
    def __init__(self):
        self.variable_stiffness_angle1 = 1170
        self.variable_stiffness_angle2 = 2518
    ...
    def process(self):
        m1 = (0+3.28)/(3340-1268)
        m2 = (3.28-0)/(2430-280)
        self.StiffnessValueToPub1 = m1*(self.variable_stiffness_angle1- 3340)#3200)
        self.StiffnessValueToPub2 = m2*(self.variable_stiffness_angle2- 280)#300)
